  ...
  return (
    <div className='flex flex-col bg-gray-600 h-screen text-gray-100'>
      ...
      <Link to='/' className={`h-1/5 p-2 hover:bg-gray-800 duration-200 flex items-center ${location.pathname === '/displayMain' && 'bg-gray-800'}`} onMouseEnter={()=> setDashHover(true)} onMouseLeave={()=>setDashHover(false)}>
        ...
        <Link to='/Bpcl_Graph' className={`h-1/5 p-2 hover:bg-gray-800 duration-200 flex items-center ${location.pathname === '/displayGraph' && 'bg-gray-800'}`} onMouseEnter={()=> setGraphHover(true)} onMouseLeave={()=>setGraphHover(false)}>
        ...
        <Link to='/Bpcl_Report' className={`h-1/5 p-2 hover:bg-gray-800 duration-200 flex items-center ${location.pathname === '/displayReport' && 'bg-gray-800'}`} onMouseEnter={()=> setReportHover(true)} onMouseLeave={()=>setReportHover(false)}>
        ...
        <Link to='/Bpcl_Settings' className={`h-1/5 p-2 hover:bg-gray-800 duration-200 flex items-center ${location.pathname === '/displaySettings' && 'bg-gray-800'}`} onMouseEnter={()=> setSettingsHover(true)} onMouseLeave={()=>setSettingsHover(false)}>
